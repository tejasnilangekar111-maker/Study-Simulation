...
export default function TodoPage() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-lofi-950 text-offwhite">
      ...
      <div className={`relative z-10 ${contentPaddingClass} px-6 py-24 max-w-4xl mx-auto transition-[padding] duration-300`}>
        <button
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-10">
          <div className="glass rounded-xl p-4">
            <p className="text-xs uppercase tracking-wide text-offwhite/60 mb-1">Completed Today</p>
            <p className="text-2xl font-bold text-emerald-400">
              {doneToday}/{todos.length}
            </p>
          </div>
          <div className="glass rounded-xl p-4">
            <p className="text-xs uppercase tracking-wide text-offwhite/60 mb-1">Today's Goals</p>
            <p className="text-2xl font-bold text-coral-500">{goals.length}</p>
          </div>
          <div className="glass rounded-xl p-4 col-span-2 sm:col-span-1">
            <p className="text-xs uppercase tracking-wide text-offwhite/60 mb-1">Pending</p>
        ...
        <div className="flex gap-2 mb-8">
          ...
          <button
            onClick={submit}
            className="bg-accent-blue/90 hover:bg-accent-blue text-walnut-950 rounded-xl px-5 font-medium flex items-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offwhite"
          >
            <FiPlus size={16} /> Add
          </button>
        </div>
        ...
        <section className="mb-10">
          ...
          {pendingTodos.length === 0 ? (
            <div className="glass rounded-xl p-8 text-center text-offwhite/55 text-sm">
